      ...
      <div className="container">
        ...
        <div className="grid gap-8 lg:grid-cols-2">
          ...
          >
            ...
            />
            {product.badge && (
              <span className="gold-gradient absolute top-4 right-4 rounded-lg px-3 py-1 text-sm font-bold text-primary-foreground">
                {product.badge}
              </span>
            )}
            {discount > 0 && (
          ...
          >
            <span className="mb-2 inline-block rounded-md bg-secondary px-3 py-1 text-xs font-medium text-secondary-foreground">
              رقمي • تفعيل فوري
            </span>
              ...
              <div className="mt-6 rounded-xl border border-border bg-card p-4">
                <div className="flex items-baseline gap-3">
                  <span className="text-3xl font-bold text-primary">
                    {selectedVariant.salePrice || selectedVariant.price} ر.س
                  </span>
            ...
            <div className="mt-6">
              ...
              <ul className="space-y-2">
                {[
                  ...
                  "ضمان كامل مدة الاشتراك",
                  "دعم فني على مدار الساعة",
                  "إمكانية التجديد بسعر مخفض",
                ].map((feature) => (
